...
require 'SMTP.php'; 
$sql=mysqli_query($con,"SELECT * FROM `tbl_login` WHERE `uname`='$eemail'");
...
try {
  ...
  //  $mail->addCC('cc@example.com');
   ...
   /// $mail->addAttachment('/var/tmp/file.tar.gz');         //Add attachments
    ...
    $mail->Body    = 'Welcome to Traffic Squard..<br>Online Traffic Offence Reporting website<br>
    <a href="http://localhost/Traffic%20Offense%20Reporting/restpassword.php?login_id='.$logid.'">
