...
td
{
    ...
    font-family: "Times New Roman", Times, serif;
											  ...
											  <tr>
												  <td style="background-color:#95B9C7;">Amount to be Paid:</td>
...
<br><br>
<center><button  onclick="printDiv('print')"><h3><b>&nbsp&nbsp&nbsp&nbsp Receipt &nbsp&nbsp&nbsp&nbsp</b></h3></button>
<button class="inv-btn" onclick="return show();"><h3><b> &nbsp&nbsp&nbsp&nbsp Finish &nbsp&nbsp&nbsp&nbsp </b></h3></button>
</center>
<script>
	function show(){
	window.location = "offender_offenselist.php";
