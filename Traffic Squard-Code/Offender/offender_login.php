			...
			<div class="container">
				<div class="row">
					...
					<div class="user_box ml-auto">
							...
							<div class="user_box_login user_box_link"><a href="offender_login.php">Payment</a></div>
  ...
  pointer-events:none;
	...
	<div class="container-login100" style="background-image: url('images/');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30" style="margin-top: 189px;">
			<form class="login100-form validate-form" action="offender_login_action.php" method="post">
	...
	<div id="validation-message" style="color:red;text-align:center;">
		...
		?><hr>
				...
				<div class="wrap-input100 validate-input m-b-20">
					<input class="input100" type="text" name="vehicleno" placeholder="Vehicle Number"style="text-transform:uppercase">
				...
				<div class="container-login100-form-btn">
					<button  style="background-color:green; border-color:blue; color:white" type="submit" class="login100-form-btn">
						Login
					</button>
				</div>
<br>
