                ...
                <hr>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="nme"  value ="<?php echo $row['r_name'];?>" id="first_name" placeholder="first name"title="enter your first name if any."required readonly>
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Last name</h4></label>
                              <input type="text" class="form-control" name="lnme" value ="<?php echo $row['r_lname'];?>" id="last_name" placeholder="last name" title="enter your last name if any."required readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Mobile</h4></label>
                              <input type="text" class="form-control" name="phn" value ="<?php echo $row['r_phone'];?>" id="mobile" placeholder="enter mobile number" title="enter your mobile number if any." required onchange="Validat();">
                          </div>
                      </div>
                      <script>
function Validat() 
    ...
    return true;
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="date" class="form-control" name="dob" value ="<?php echo $row['r_dob'];?>"readonly>
                          </div>
                      </div>
                      <div class="form-group">
