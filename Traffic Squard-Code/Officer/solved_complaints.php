...
<font color="white"><a href="officer_complaintview.php" style="color:black">Pending Complaints</a></b></button></div>
</br>
<?php

$res1=mysqli_query($con,"SELECT `complaint_id`, `r_id`, `c_date`, `c_msg`, `district`, `place`, `c_status` FROM `tbl_complaint` WHERE `district`='$asa' and c_status='accepted'");
...
{
?>
<div class="content mt-3"><h3><font color="blue"><center>Proccessed Complaints</h3><br></font>
<br>
<table>
...
<?php
	...
	$a=$_SESSION['r_id'];
	$res=mysqli_query($con,"SELECT * FROM `tbl_complaint` where  district='$asa' and c_status='accepted'");
	$i=1;
