...
include 'dbconnect.php';
    ...
    ?>
        ...
        <div class="content mt-3"><h1><font color="green"><center>PENDING COMPLAINTS</h1><br></font>
        <br>
        <button class="btn btn-success" style="background-color:#0277BD;border-color:#0277BD;"><b>
    <font color="white"><a href="admincomplaintss.php" style="color:black">Accepted Complaints</a></b></button>
<?php
include 'dbconnect.php';
...
<?php
	...
	$a=$_SESSION['r_id'];
	$res=mysqli_query($con,"SELECT * FROM `tbl_complaint` where c_status='pending'");
	$i=1;
