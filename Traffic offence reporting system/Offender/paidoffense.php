...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button class="btn btn-info" style=""><b>
    <font color="white"><a href="offender_offenselist.php"style="color:black">Back</a></b></button><br>
</br>
...
$re=mysqli_query($con,"SELECT * FROM `offense committed` WHERE `Vehicle_Number`='$r' and `payment`='paid'");
?>
<table>
...
<tr>
            ...
            <td><button class="btn btn-success"><b>
    <font color="white"><a href="./TrafficView/Offenderdetails.php?id=<?php echo $id;?>" style="color:black">view</a></b></button>
    &nbsp&nbsp<button class="btn btn-info"><b>
    <font color="white"><a href="billing.php?id=<?php echo $id;?>" style="color:black">Receipt</a></b></button></td>
