...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/d5.jpg"></div>
		<div class="home_content">
			<div class="home_title" style="color:black">Our rules</div>
		</div>
	</div>
	...
	$q = mysqli_query($con,"SELECT * FROM `tbl_rule` order by rule_id desc");
	$count=0;
	?>
	...
	<div class="milestones">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="milestone">
						<h4 style="color: black;"><?php echo $count.". ".$sq['rule'];  ?></h4>
						<br>
					</div>
				</div>
<?php } ?>
